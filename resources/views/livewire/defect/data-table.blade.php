                                ...
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" @click.outside="open = false" x-transition
                                        ...
                                        <button type="button" wire:loading.attr="disabled"
                                            wire:target="deleteDefect({{ $defect->id }})"
                                            @click="Swal.fire({
                                                title: 'Are you sure?',
                                                text: 'The selected defect will be permanently deleted!',
                                                icon: 'warning',
                                                ...
                                                if (result.isConfirmed) {
                                                    $wire.deleteDefect({{ $defect->id }})
                                                }
                                            })"
                                            class="px-2 py-1 text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 transition-colors"
                                            title="Delete">
                                            <i wire:loading.remove wire:target="deleteDefect({{ $defect->id }})"
                                                class="fa-solid fa-trash-can"></i>
                                            <span wire:loading wire:target="deleteDefect({{ $defect->id }})"
                                                class="ml-1">
                                                <i class="fa-solid fa-spinner animate-spin"></i>
                                            </span>
                                        </button>
