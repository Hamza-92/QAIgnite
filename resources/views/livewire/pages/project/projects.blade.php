<div>
    <div class="px-8 py-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-700">
        <button x-on:click="$wire.createProject = true"
            class="px-4 py-2 bg-blue-500 hover:bg-blue-600 dark:bg-blue-800 dark:hover:bg-blue-900 text-white dark:text-gray-300 rounded-md"
            type="button">Create Project</button>
        <a href="{{ route('projects.archive') }}"
            class="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 dark:bg-indigo-800 dark:hover:bg-indigo-900 text-white dark:text-gray-300 rounded-md cursor-pointer"
            ...
            <div class="p-8">
                <form wire:submit.prevent='save'>
                    <div class="grid sm:grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input wire:model='name' type="text" name="name" id="name"
                                class="rounded-md border-gray-200 dark:bg-gray-700 dark:border-gray-700">
                            @error('name')
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <div x-data='{open_model : false}' class="relative w-full"
                                ...
                                <div @click.stop="open_model = !open_model"
                                    class="w-full flex items-center rounded-md border border-gray-200 dark:bg-gray-700 dark:border-gray-700 px-4 py-1 cursor-pointer">
                    ...
                    <div x-data="{ open: false }" class="mt-4">
                        <div @click="open = !open"
                            class="flex items-center justify-between bg-blue-500 hover:bg-blue-600 text-white dark:bg-blue-800 dark:hover:bg-blue-900 px-4 py-2 cursor-pointer">
                        ...
                        <div x-show="open" class="grid grid-cols-2 gap-4 mt-4">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <div x-data='{open_model : false}' class="relative w-full"
                                    @click.outside="open_model = false" @close.stop="open_model = false">
                                    <div @click.stop="open_model = !open_model"
                                        class="w-full h-10 flex items-center rounded-md border border-gray-200 dark:bg-gray-700 dark:border-gray-700 px-4 py-1 cursor-pointer">
                                        <div class="w-full flex items-center justify-start gap-2 flex-wrap">
