<div>
    <div class="flex items-center justify-between flex-wrap gap-4 px-8 py-4 border-b dark:border-gray-700">
        <div class="flex flex-col items-start">
            ...
            <h2 class="text-lg font-medium mt-2">{{ $test_scenario->name }}</h2>
        </div>
                ...
                <tr class="border-b dark:border-gray-700">
                    ...
                    <td class="w-full px-4 py-3">
                        @if($test_scenario->requirement)
                            <a href="{{ route('requirement.detail', $test_scenario->requirement->id) }}" class="underline">{{ $test_scenario->requirement->requirement_title }}</a>
                        @endif
                    </td>
                </tr>
                <tr class="border-b dark:border-gray-700">
                    <th class="px-4 py-3 border-r dark:border-gray-700 bg-gray-100 dark:bg-gray-800 font-medium">
                        Test Scenario</th>
                    <td class="w-full px-4 py-3">{{ $test_scenario->name }}</td>
                </tr>
                <tr class="border-b dark:border-gray-700">
                    <th class="px-4 py-3 border-r dark:border-gray-700 bg-gray-100 dark:bg-gray-800 font-medium">
                        Description</th>
                    <td class="w-full px-4 py-3">{{ $test_scenario->description }}</td>
                </tr>
                <tr class="border-b dark:border-gray-700">
