<div x-data="{
    ...
    <div x-show="confirmationModel" x-transition:enter="transition ease-out duration-300"
        ...
        <div
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Delete Test Scenario</h3>
            <p class="text-sm text-gray-700 dark:text-gray-300">Are you sure you want to delete this Test Scenario and
                its associated data?
            </p>
            ...
            <div class="mt-6 space-x-3">
                <button type="button"
                    @click="$wire.delete(test_scenario_id); confirmationModel = false; test_scenario_id = null"
                ...
                <button type="button" @click="confirmationModel = false; test_scenario_id = null"
