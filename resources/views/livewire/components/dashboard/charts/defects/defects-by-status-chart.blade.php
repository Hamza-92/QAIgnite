<div x-data="{showDataTable:false}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
    ...
    {{-- Chart --}}
    <div wire:ignore x-data="defectsByStatusChart()" x-init="initChart()" x-cloak class="w-full p-4 relative">
        <div x-ref="chart" class="w-full"></div>
    </div>

    <script>
        function defectsByStatusChart() {
            return {
                chart: null,
                    ...
                    return {
                        ...
                        chart: {
                            ...
                            events: {
                                dataPointSelection: (event, chartContext, config) => {
                                    const defectStatus = this.labels[config.dataPointIndex];
                                    Livewire.dispatch('showDefectsByStatus', {
                                        defectStatus: defectStatus
                                    });
                        ...
                        tooltip: {
                            ...
                            y: {
                                ...
                                //     const statuses = @json($defectStatusLabels);
                                //     return `<strong>${value} ${statuses[seriesIndex]} priority defects</strong>`;
                                // }
                            }
                        },
                        plotOptions: {
    ...
    <div x-show='showDataTable' x-cloak @keydown.escape.window="showDataTable = false"
        ...
        <div
            ...
            <div
                ...
                <button @click="showDataTable = false; $wire.defectsByStatus = []" type="button"
            ...
            <div class="flex-1 overflow-y-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @isset($defectsByStatus)
                            @forelse ($defectsByStatus as $defect)
                                <tr wire:key='{{ $defect->id }}'
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span @class([
                                            ...
                                            'text-gray-500' => $defect->def_severity === 'major',
