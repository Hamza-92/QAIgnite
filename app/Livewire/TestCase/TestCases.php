...
class TestCases extends Component
{
    ...
    public function initializeValues()
    {
        ...
        $this->tc_name = '';
        $this->tc_description = '';
        $this->tc_status = 'pending';
        $this->tc_approval_request = null;
        $this->tc_project_id = auth()->user()->default_project;
        $this->tc_build_id = null;
        $this->tc_module_id = null;
        $this->tc_requirement_id = null;
        $this->tc_test_scenario_id = null;
        $this->tc_testing_type = null;
        $this->tc_estimate_time = null;
        $this->tc_pre_conditions = '';
        $this->tc_detailed_steps = '';
        $this->tc_expected_result = '';
        $this->tc_post_conditions = '';
        $this->tc_execution_type = null;
        $this->tc_priority = 'low';
        $this->tc_assigned_to = null;
        $this->tc_comment = '';
    ...
    */
    ...
    {
        $this->test_case = TestCase::findOrFail($id);

        $this->tc_id = $this->test_case->id;
        ...
        if ($this->create) {
            ...
            if ($this->uploadedAttachments) {
                foreach ($this->uploadedAttachments as $attachment) {
                    ...
                    $path = $attachment->storeAs('attachments/test-cases', $customName);
            ...
            $this->test_case = TestCase::create([
    ...
    {
        return view('livewire.test-case.test-cases');
    }
}
